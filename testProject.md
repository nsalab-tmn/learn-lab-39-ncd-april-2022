...
После установки eve-ng для всех интерфейсов операционной системы были созданы виртуальные бриджи ```pnet*```. Интерфейс pnet0 является виртуальным коммутируемым интерфейсом для интерфейса ```eth0``` и используется для управления и подключения виртуальных машин к сети управления.
...
Добавьте виртуальный NAT-бридж. В меню **Add a new object** выберите **Network**. В выпадающем списке Type выберите **Cloud1** - данный бридж соответствует виртуальному интерфейсу **pnet1**, с помощью которого вы ранее настроили трансляцию сетевых адресов.
...
На экранной клавиатуре необходимо нажать сочетание клавиш Ctrl+Alt+Del для вызова окна авторизации. После появления приглашения для ввода пароля, сочетание клавиш на экранной клавиатуре нужно отжать, снова вызвать боковую панель Guacamole сочетанием клавиш Ctrl+Alt+Shift и убрать экранную клавиатуру.
